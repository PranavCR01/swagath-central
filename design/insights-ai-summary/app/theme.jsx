...
function buildSeed() {
  ...
  const sandhyaShows = [
    ...
    },
    {
      ...
      occ: 92, status: 'complete',
      counters: {
        main: seedRows(MENU.main, { vegpuff: 56, eggpuff: 34, samosa: 24, cknpuff: 28, chips: 44, water: 78, frooty: 32, tin: 20 }),
        popcorn: seedRows(MENU.popcorn, { cone_s: 58, cone_m: 40, cone_l: 22, bms: 3600 }),
        cool: seedRows(MENU.cool, { c_water: 84, c_tin: 26, c_frooty: 30, c_fries: 24, c_cpop: 18, c_csam: 12, c_sand: 14 }),
      },
      parking: { scooter: '88', auto: '16', car: '40', reported: '4500' },
      payments: { upi: '11200', cash: '8120' },
    },
    {
